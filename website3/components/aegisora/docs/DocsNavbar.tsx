    ...
    <header className="sticky top-0 z-50 w-full border-b border-white/10 bg-[#0A0D18] text-white">
      <div className="flex h-16 items-center px-4 md:px-6 gap-4">
        ...
        <div className="flex-1 flex justify-center max-w-2xl mx-auto hidden lg:flex">
          <button onClick={handleOpenAI} className="flex items-center gap-2 w-full max-w-[400px] bg-white/5 border border-white/10 hover:border-white/20 transition-colors rounded-lg px-3 py-1.5 text-white/50 text-[13px] cursor-pointer">
            <Search size={14} />
        ...
        <div className="flex items-center gap-4 shrink-0 ml-auto">
          <button onClick={handleOpenAI} className="hidden md:flex items-center gap-2 text-[13px] font-medium text-white/80 hover:text-white transition-colors cursor-pointer">
